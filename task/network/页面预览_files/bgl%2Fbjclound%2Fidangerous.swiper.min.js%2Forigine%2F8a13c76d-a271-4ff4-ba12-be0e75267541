...
if (document.location.href.indexOf('www.zbj.com/anli') > 0) {
	$('a[data-linkid="10041537"]').hide();
	$('.box-channel-siderbar[uid="3346fb9707"]').hide()
	$('.multi-nav-div .multi-nav-ul .multi-link').eq(7).hide();
	$('.menu-list-wrap.J-menu-wrap').hide();
	$('.zbj-grid[uid="0a500f093c"]').hide();
	$('.zbj-grid[uid="04e9f2118c"]').hide();

	$('head').append($("<style>.menu-list-wrap.J-menu-wrap{display: none;}</style>"));
}
